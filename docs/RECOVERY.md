...
- Losing the *path* to the node rather than the node. The tailnet relay (DERP)
  ...
  [NETWORK-PATHS.md](NETWORK-PATHS.md), *Risk: the tailnet relay (DERP) -
  accepted*.
